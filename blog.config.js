...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '老斜坡的妙妙屋', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://space.bilibili.com/396425978?spm_id_from=333.1007.0.0', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '斜坡, 博客', // 网站关键词 英文逗号隔开
  ...
  POST_SHARE_BAR_ENABLE: process.env.NEXT_PUBLIC_POST_SHARE_BAR || 'false', // 文章分享功能 ，将在底部显示一个分享条false true
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '老斜坡的妙妙屋', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
        process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '老斜坡的资源分享库', // 站点描述，被notion中的页面描述覆盖
